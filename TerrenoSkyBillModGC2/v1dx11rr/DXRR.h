...
public:	
    ...
    DXRR(HWND hWnd, int Ancho, int Alto)
	{
		...
		m04woodenCabinB = new M04woodenCabinB(d3dDevice, d3dContext, "Assets//004_WoodenCabinObj//004_WoodenC02New.obj", L"Assets/004_WoodenCabinObj/WoodCabinDif.jpg", L"Assets/Cofre/Cofre-spec.png", -70.0f, -40.0f);
		m05RuinedBuilding = new M05RuinedBuilding(d3dDevice, d3dContext, "Assets//005_Ruined_building_OBJ//005_Newruinedbuilding.obj", L"Assets/005_Ruined_building_OBJ/text.jpg", L"Assets/Cofre/Cofre-spec.png", -70, 100.0f);
		m06campfire = new M06campfire(d3dDevice, d3dContext, "Assets//006_campfire//006_CampfireNew.obj", L"Assets/006_campfire/brick.jpg", L"Assets/Cofre/Cofre-spec.png", -60.0f, 0.0f);
		...
		m09molino = new M09molino(d3dDevice, d3dContext, "Assets//009Molino//MolinoNew.obj", L"Assets/009Molino/windmill_diffuse.png", L"Assets/Cofre/Cofre-spec.png", -70.0f, -100.0f);
		m10flag = new M10flag(d3dDevice, d3dContext, "Assets//010_flag//0010_FlagNew.obj", L"Assets//010_flag/010_FlagB.jpg", L"Assets/Cofre/Cofre-spec.png", 20.0f, -10.0f);
		m11barrel = new M11barrel(d3dDevice, d3dContext, "Assets//011_barrel//0011_BarrelNew.obj", L"Assets/011_barrel/barrel_diffuse.png", L"Assets/Cofre/Cofre-spec.png", -60.0f,-9.0f);
		m12bride = new M12bride(d3dDevice, d3dContext, "Assets//012_Bridge//0012_BridgeNew.obj", L"Assets/012_Bridge/BridgeMap.jpg", L"Assets/Cofre/Cofre-spec.png", -150.0f, -100.0f);
		m13pozo = new M13pozo(d3dDevice, d3dContext, "Assets//013_Pozo//PozoNew.obj", L"Assets/013_Pozo/brick.jpg", L"Assets/Cofre/Cofre-spec.png", -100.0f, -90.0f);
		m14TreeMonster = new M14TreeMonster(d3dDevice, d3dContext, "Assets//014_treem//0014_TreeNew.obj", L"Assets/014_treem/014color.png", L"Assets/Cofre/Cofre-spec.png", 0.0f, -50.0f);
		m15minibridge = new M15minibridge(d3dDevice, d3dContext, "Assets//015_MiniBridge//0015_BridgeNew.obj", L"Assets/015_MiniBridge/Castlewalls_1.png", L"Assets/Cofre/Cofre-spec.png", 0.0f,55.0f);
		...
		m17castleA = new M17castleA(d3dDevice, d3dContext, "Assets//017_Castelo//017_CastleNewA01.obj", L"Assets/017_Castelo/download.jpg", L"Assets/Cofre/Cofre-spec.png", 40.0f, -65.0f);
