//#pragma once
#ifndef _M18MarketGray
#define _M18MarketGray
...
public:
	M18MarketGray(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
