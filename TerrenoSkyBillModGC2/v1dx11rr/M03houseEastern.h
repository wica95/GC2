//#pragma once
#ifndef _M03houseEastern
#define _M03houseEastern
...
public:
	M03houseEastern(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
