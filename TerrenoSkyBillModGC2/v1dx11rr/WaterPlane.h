...
bool WaterShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	bool compileResult = CompileD3DShader(L"Water.vs", "VS_Main", "vs_5_0", &vertexShaderBuffer);
	...
	compileResult = CompileD3DShader(L"Water.ps", "PS_Main", "vs_5_0", &pixelShaderBuffer);
		if (compileResult == false)
		{
			return false;
		}
