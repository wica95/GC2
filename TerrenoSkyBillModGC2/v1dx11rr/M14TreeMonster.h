//#pragma once
#ifndef _M14TreeMonster
#define _M14TreeMonster
...
public:
	M14TreeMonster(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
