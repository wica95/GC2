//#pragma once
#ifndef _M16fountainA
#define _M16fountainA
...
public:
	M16fountainA(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
