//#pragma once
#ifndef _Modelo001church
#define _Modelo001church
...
public:
	Modelo001church(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
