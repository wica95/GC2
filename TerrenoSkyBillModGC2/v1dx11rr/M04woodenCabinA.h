//#pragma once
#ifndef _M04woodenCabinA
#define _M04woodenCabinA
...
public:
	M04woodenCabinA(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
