//#pragma once
#ifndef _M05RuinedBuilding
#define _M05RuinedBuilding
...
public:
	M05RuinedBuilding(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
	...
	bool CargaParametros(char* ModelPath, WCHAR* diffuseTex, WCHAR* specularTex)
	{
		...
		bool compileResult = CompileD3DShader(L"ModeloTest.fx", "VS_Main", "vs_4_0", &vsBuffer);
		...
		compileResult = CompileD3DShader(L"ModeloTest.fx", "PS_Main", "ps_4_0", &psBuffer);
