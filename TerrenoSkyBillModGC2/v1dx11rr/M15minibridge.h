//#pragma once
#ifndef _M15minibridge
#define _M15minibridge
...
public:
	M15minibridge(ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext, char* ModelPath, WCHAR* colorTexturePath, WCHAR* specularTexturePath, float _posX, float _posZ)
	{
